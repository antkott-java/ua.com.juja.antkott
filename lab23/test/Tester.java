...
class Tester {
    ...
    void shouldReturn_NullAsRow() {
        ...
        assertEquals(null, arrayUtilsEntity.rotateClockwise(new int[][][]{null}), "check null input2");
    }

    int[][][] matrix = new int[][][]{{{0, 0}, {0, 0}}, {{0, 0}, {0}}};

    @Test
    void shouldReturn_NullWhenDifferentSize() {//
        assertEquals(null, arrayUtilsEntity.rotateClockwise(matrix), "check null input2");
    }
