...
class Tester {
    ...
    @Test
    void shouldReturn_SortedArray_BubbleSortMy() {
        assertArrayEquals(outputData, laboratoryWorkEntity.bubbleSortMy(inputData), "check equals");
    }

    @Test
    void shouldReturn_SortedArray_BubbleSortLab14() {
        assertArrayEquals(outputData, laboratoryWorkEntity.bubbleSortLab14(inputData), "check equals");
    }

    @Test
    void shouldReturn_SortedArray_BubbleSortLab14My() {
        assertArrayEquals(outputData, laboratoryWorkEntity.bubbleSortLab14My(inputData), "check equals");
    }
