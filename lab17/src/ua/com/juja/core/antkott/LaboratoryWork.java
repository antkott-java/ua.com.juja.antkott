...
Про Stack мы детальнее поговорим в следующих уроках. Пока что это структура данных,
 которая хранит множество элементов и реализует принцип LIFO (last in first out) - последний пришел, первый ушел.
